...
class FileProcessor:
    ...
    SKennedy,02/27/2026,Created Class
    """
    @staticmethod
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        SKennedy,02/27/2026,Created function

        :param file_name: (str) The name of the JSON file to read from.
        :param student_data: (list) The list to load student enrollment data into.
        :return: None
        """
        file = None
        try:
    ...
    def write_data_to_file(file_name: str, student_data: list):
        """ Writes a list of student enrollment dictionaries to a JSON file.

        ChangeLog: (Who, When, What)
        SKennedy,02/27/2026,Created function

        :param file_name: (str) The name of the JSON file to write to.
        :param student_data: (list) The list of student enrollment dictionaries to save.
        :return: None
        """
        file=None
        success = False
...
class IO:
    ...
    def output_error_messages(message: str, error: Exception=None):
        """ Displays a custom error message to the user, with an optional technical details block.

        ChangeLog: (Who, When, What)
        SKennedy,02/27/2026,Created function

        :param message: (str) The custom error message to display.
        :param error: (Exception) Optional exception object to display technical details. Defaults to None.
        :return: None
        """
        print(f"\n{message}")
...
#while (True):
    ...
    def output_menu(menu: str):
        ...
        :param menu: (str) The menu string to display.
        :return: None
        """
        print(menu)
    ...
    def input_menu_choice():
        """ Prompts the user to enter a menu choice and returns the selected value.

        ChangeLog: (Who, When, What)
        SKennedy,02/27/2026,Created function

        :return: (str) The menu choice entered by the user.
        """
    ...
    def output_student_courses(student_data: list):
        """ Displays the current list of student course enrollments to the user.

        ChangeLog: (Who, When, What)
        SKennedy,02/27/2026,Created function

        :param student_data: (list) The list of student enrollment dictionaries to display.
        :return: None
        """
        print("-" * 50)
    ...
    def input_student_data(student_data: list):
        """ Prompts the user to enter a student first name, last name, and course name,
        validates the input, and appends the new record to the student data list.

        ChangeLog: (Who, When, What)
        SKennedy,02/27/2026,Created function

        :param student_data: (list) The list to append the new student enrollment record to.
        :return: None
        """
        try:
